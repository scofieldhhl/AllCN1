...
public class SedmHotReDetailsMovieItemDecoration extends RecyclerView.ItemDecoration {

    private int rightOffset;

    public SedmHotReDetailsMovieItemDecoration() {
        this.rightOffset = (int) AppMain.res().getDimension(
                R.dimen.sedm_hot_re_details_movie_right_space);
    }
