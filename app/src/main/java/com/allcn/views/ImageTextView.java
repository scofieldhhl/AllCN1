...
public class ImageTextView extends TextView {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        mScaleWidth = (int) typedArray
                .getDimension(R.styleable.ImageTextView_drawableWidth, 0);
        mScaleHeight = (int) typedArray.getDimension(R.styleable.ImageTextView_drawableHeight,
                0);
