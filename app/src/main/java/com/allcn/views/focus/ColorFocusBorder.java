...
public class ColorFocusBorder extends AbsFocusBorder {
    ...
    private ColorFocusBorder(Context context, int shimmerColor, long shimmerDuration,
    ...
    public final static class Builder extends AbsFocusBorder.Builder {
        ...
        public FocusBorder build(ViewGroup parent) {
            ...
            final ColorFocusBorder boriderView = new ColorFocusBorder(parent.getContext(),
                    ...
                    mShadowColor, mShadowWidth, mBorderColor, mBorderWidth, needDuplicateIdleStatus);
