...
public class DrawableFocusBorder extends AbsFocusBorder {
    ...
    private DrawableFocusBorder(Context context, int shimmerColor, long shimmerDuration,
                                boolean isShimmerAnim, long animDuration, RectF paddingOfsetRectF,
                                Drawable borderDrawable, boolean needDuplicateIdleStatus) {
        super(context, shimmerColor, shimmerDuration, isShimmerAnim, animDuration, paddingOfsetRectF,
                needDuplicateIdleStatus);
    ...
    @Override
    List<Animator> getTogetherAnimators(float newX, float newY, int newWidth, int newHeight, Options options) {
        return null;
    }

    @Override
    List<Animator> getSequentiallyAnimators(float newX, float newY, int newWidth, int newHeight, Options options) {
        return null;
    }
    ...
    public final static class Builder extends AbsFocusBorder.Builder {
        ...
        public FocusBorder build(ViewGroup parent) {
            ...
            final DrawableFocusBorder boriderView = new DrawableFocusBorder(
                    ...
                    mAnimDuration, mPaddingOfsetRectF, drawable, needDuplicateIdleStatus);
