...
public class DataCenter2 extends ActerCls {
    ...
    private boolean forceTvOK, initSOing, vodTvDataOK, vodTvDatIng, playBackDataOK, playBackDatIng,
    ...
    private static final DataCenter2 ourInstance = new DataCenter2();

    public static DataCenter2 Ins() {
        return ourInstance;
    }
    ...
    public void addDataListener(OnDataListener onDataListener) {
        if (onDataListener == null) {
            return;
        }
        if (onDataListeners.indexOf(onDataListener) < 0) {
    ...
    private static class MBroadcastReceiver extends BroadcastReceiver {
        ...
        private DataCenter2 dataCenter;

        public MBroadcastReceiver(DataCenter2 dataCenter) {
    ...
    public static class MarqueeTask implements Runnable {//主界面的跑马灯效果
        ...
        public MarqueeTask(DataCenter2 dataCenter, Class cls) {
            this.dataCenter = dataCenter;
            this.cls = cls;
        }
    ...
    public static class UpdateTask implements Runnable {
        ...
        public UpdateTask(DataCenter2 dataCenter) {
            this.dataCenter = dataCenter;
        }
    ...
    private static class ScanTimeTask implements Runnable {
        ...
        public ScanTimeTask(DataCenter2 dataCenter) {
            this.dataCenter = dataCenter;
        }
    ...
    private static class LoginTask implements Runnable {
        ...
        public LoginTask(DataCenter2 dataCenter) {
            this.dataCenter = dataCenter;
        }
    ...
    private static class InitForceTVTask implements Runnable {
        ...
        private DataCenter2 hostCls;

        public InitForceTVTask(DataCenter2 hostCls) {
    ...
    private static class InitMediaDatasTask implements Runnable {
        ...
        public InitMediaDatasTask(DataCenter2 hostCls) {
            this.hostCls = hostCls;
        }
    ...
    private static class GetNetSpeedTask implements Runnable {
        ...
        public GetNetSpeedTask(DataCenter2 hostCls) {
            this.hostCls = hostCls;
        }
    ...
    private class PayTask implements Runnable {
        ...
        public PayTask(DataCenter2 hostCls, String num, String pwd) {
            this.hostCls = hostCls;
            this.num = num;
            this.pwd = pwd;
        }
...
//            MLog.d(TAG, String.format("ScanCkindTask pCid=%s cKindObjNum=%d", pCid, cKindObjNum));
    ...
    private static class ScanMovieDetailsTask implements Runnable {
        ...
        public ScanMovieDetailsTask(DataCenter2 hostCls, Activity activity, MovieObj movieObj) {
            this.hostCls = hostCls;
...
//                Utils.saveStrDataToSD(AppMain.ctx(), "details.txt", detailsVal);
    ...
    private static class InsertFavMovieTask implements Runnable {
        ...
        public InsertFavMovieTask(DataCenter2 hostCls, Object object, boolean isFav) {
            this.hostCls = hostCls;
            this.object = object;
            this.isFav = isFav;
        }
    ...
    private static class SendForceTVHttpReqTask implements Runnable {
        ...
        public SendForceTVHttpReqTask(DataCenter2 hostCls, MovieObj movieObj) {
            this.hostCls = hostCls;
            this.movieObj = movieObj;
        }
    ...
    private static class SendForceTVHttpReqTask1 implements Runnable {
        ...
        public SendForceTVHttpReqTask1(DataCenter2 hostCls, int pos, String movieName, int movieId,
                                       String colId) {
            this.hostCls = hostCls;
...
//                    this.pageIndex, pCid, cKindObjNum));
    ...
    private static class HandleChalInFavTask implements Runnable {
        ...
        public HandleChalInFavTask(DataCenter2 hostCls, LiveAct liveAct) {
            this.hostCls = hostCls;
    ...
    private static class GetLiveDataTask implements Runnable {
        ...
        public GetLiveDataTask(DataCenter2 hostCls, LiveAct liveAct) {
            this.hostCls = hostCls;
            this.liveAct = liveAct;
        }
        ...
        public void run() {
            ...
            try {
                ...
                liveAct.liveKinds = DBMgr.Ins().queryLiveKinds();
    ...
    private static class PlayChal implements Runnable {
        ...
        public PlayChal(LiveAct liveAct, DataCenter2 hostCls, boolean autoPlay) {
            this.liveAct = liveAct;
            this.hostCls = hostCls;
    ...
    private static class SendLiveForceTVHttpReqTask implements Runnable {
        ...
        public SendLiveForceTVHttpReqTask(DataCenter2 hostCls, String filmId, String vodId, String colId) {
            this.hostCls = hostCls;
            this.filmId = filmId;
            this.vodId = vodId;
            this.colId = colId;
    ...
    private static class CacheTask implements Runnable {
        ...
        public CacheTask(DataCenter2 hostCls, LiveAct liveAct, LiveChalObj chal) {
            this.hostCls = hostCls;
            this.chal = chal;
            this.liveAct = liveAct;
        }
    ...
    public static class GetPlayBackEpgTask implements Runnable {

        private DataCenter2 hostCls;
        private PlayBackAct act;
        private boolean isRunning;

        public GetPlayBackEpgTask(DataCenter2 hostCls, PlayBackAct act) {
            this.hostCls = hostCls;
            this.act = act;
        }
            ...
            try {
                ...
                do {
                    epgStr = NetUtils.Ins(AppMain.ctx()).getUrlStr(
                            epgUrl, cmsObj.getToken(), null, null);
...
//                MLog.d(TAG, "itemStr=" + itemStr);
                ...
                List<EpgObj> yyEpgObjs = epgParser.getYyEpgs();

                for (int i = 0; i < yyEpgNum && isRunning; i++) {
                ...
                for (int i = 0; i < zhEpgNum && isRunning; i++) {
...
//                            epgObj.getName()), itemStr);
                ...
                if (hostCls.playBackDataOK) {
                    ...
                    if (act != null) {
                        act.loadEpgs(yyEpgObjs,  zhEpgObjs );
                    }
                }
                Thread.sleep(0);
            } catch (Exception e) {
    ...
    private static class SendPlayBackForceTVHttpReqTask implements Runnable {
        ...
        public SendPlayBackForceTVHttpReqTask(DataCenter2 hostCls, ChalObj chalObj) {
            this.hostCls = hostCls;
    ...
    private static class LoginPlaybackTask implements Runnable {
        ...
        public LoginPlaybackTask(DataCenter2 dataCenter) {
            this.dataCenter = dataCenter;
        }
...
//                    }
    ...
    private class InitSearchMoviesTask implements Runnable {
        ...
        public InitSearchMoviesTask(DataCenter2 dataCenter, String key, boolean isCkind,
...
//                        MLog.d(TAG, "object = " + object);
    ...
    private class SearchMoviesForPageTask implements Runnable {
        ...
        public SearchMoviesForPageTask(DataCenter2 dataCenter, String key, String cid, int pageIndex,
